...
const InstagramLayout = ({ children }: InstagramLayoutProps) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-ios-gray-50 to-instagram-50">
      <InstagramNavbar />
        ...
        <div className="container mx-auto px-4 py-3">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2 sm:gap-0">
            <div className="text-xs sm:text-sm text-ios-gray-700 font-medium w-full sm:w-auto">
              ...
              <span className="break-all text-2xs xs:text-xs sm:text-sm font-semibold bg-gradient-to-r from-instagram-600 to-pink-600 bg-clip-text text-transparent">{user?.email}</span>
            </div>
            <Button 
              variant="ghost" 
              size="sm" 
